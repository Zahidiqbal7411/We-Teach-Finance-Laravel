  ...
  <div class="main-content">
    ...
    <li class="nav-item">
        ...
        <a 
    href="{{ route('teacher_setting.create') }}" 
    class="nav-link active" 
    id="pills-teachers-tab" 
    data-bs-toggle="pill" 
    data-bs-target="#pills-teachers" 
    role="tab" 
    aria-controls="pills-teachers" 
    aria-selected="true">
    Teachers
</a>
    ...
    <li class="nav-item">
        ...
        <a 
    href="{{ route('taxonomies_setting.create') }}" 
    class="nav-link {{ request()->routeIs('taxonomies_setting.*') ? 'active' : '' }}" 
    id="pills-taxonomies-tab" 
    data-bs-toggle="pill" 
    data-bs-target="#pills-taxonomies" 
    role="tab" 
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active mt-4" id="pills-teachers" role="tabpanel"
          ...
          <div class="card p-3 shadow-sm">
            ...
            <p class="text-muted small mb-4">Manage teachers and their course revenue percentages. Teachers are
            ...
            <div class="accordion" id="teacherAccordion">
              ...
              <div class="accordion-item teacher-card border mb-2 rounded">
                <h3 class="accordion-header" id="headingOne">
                  <button class="accordion-button collapsed bg-white " type="button" data-bs-toggle="collapse"
                    data-bs-target="#teacher1" aria-expanded="false" aria-controls="teacher1">
                ...
                <div id="teacher1" class="accordion-collapse collapse" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body bg-light border-top">
                    ...
                    <button class="btn btn-dark btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#addCourseModal"
              ...
              <div class="accordion-item teacher-card border mb-2 rounded">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed bg-white" type="button" data-bs-toggle="collapse"
                    data-bs-target="#teacher2" aria-expanded="false" aria-controls="teacher2">
                    <div class="teacher-info d-flex align-items-center gap-3">
                      <div class="teacher-icon"><i class="fa-solid fa-user"></i></div>
                      <div>
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <div class="taxonomy-card">
                    ...
                    <div class="add-input">
                      <input id="subjectInput" type="text" class="form-control form-control-sm" name="subjectInput"
              ...
              <div class="col-md-6">
                <div class="settings-card">
                  ...
                  <div class="form-check mb-2 d-flex justify-content-between me-0 ms-0">
                    ...
                    <input class="form-check-input" type="checkbox" id="balanceWarning" name="balanceWarning" checked>
                  </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content p-2">
                <div class="modal-header border-0 pb-0">
                  <h5 class="modal-title fw-semibold d-flex align-items-center gap-2" id="addCourseModalLabel">
                ...
                <div class="modal-body">
                  <p class="text-muted small mb-3">
                    Set the revenue sharing percentage for <strong>Dr. Ahmed Hassan</strong> on a specific course.
                  </p>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                      <input type="number" class="form-control" id="teacherPercentage" value="70" min="0" max="100"
                        step="1">
                ...
                <div class="modal-footer border-0">
                  <button type="button" class="btn btn-dark modal-closeBtn" data-bs-dismiss="modal">Cancel</button>
