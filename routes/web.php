...
Route::middleware('auth')->group(function () {
    ...
    Route::get('teachers/{id}', [TeacherController::class, 'data'])->name('teachers.data');


// This is the routes for express course
    Route::get('express_course/create', [Express_courseController::class, 'create'])->name('express_course.create');
    Route::get('/express-courses', [Express_courseController::class, 'index'])
    ->name('express_courses.index');
